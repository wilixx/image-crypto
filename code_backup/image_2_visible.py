...
visible_data_path = "training_data_7000_0_visible"

labeled_data_path = "testing_data_9_bit_9000"
visible_data_path = "testing_data_9_bit_9000_visible"

labeled_data_path = "training_data_7000_0_16base"
visible_data_path = "training_data_7000_0_16base_visible"
data_volume=9000
data_volume=70000
...
#     im.show()
'''Old iglob operation---If max_length may be 25298 files.
for im_path in glob.iglob(labeled_data_path+"/*"):
    decod_func(im_path)
'''
    
for i in range(data_volume):
    im_path=labeled_data_path+r'/number_'+str(i)+r'.png'
    decod_func(im_path)


print "done all training_data_7000_0 to visible now"
