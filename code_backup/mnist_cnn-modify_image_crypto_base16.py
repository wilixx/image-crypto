...
class LossHistory(keras.callbacks.Callback):
    ...
    def loss_plot(self, loss_type):
        ...
        plt.savefig("loss_curve_70000_base17_epoch16.png")
        plt.show()
...
# load_model()
model.save_weights("model_W_img_crypto_7000_0_base17_epoch16.h5")
model.save("model_M_img_crypto_7000_0_base17_epoch_16.h5")
