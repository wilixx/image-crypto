...
'''
x_train = x_train_all[0:60000]
x_test = x_train_all[60000:70000]
y_train = y_train_all[0:60000]
y_test =y_train_all[60000:70000]
...
# model.load_weights("model_W_img_crypto_7000_0_base17.h5")
model.load_weights("model_W_img_crypto_7000_0_base17_epoch16.h5")
...
#     x_test = x_test.reshape(x_test.shape[0], 3, img_rows, img_cols)
    y=model.predict(x)
#     print("y=",y)
    y= np.argmax(y,axis=1)# y=[3,5,7,9,9,14,13,...]
    '''To get the [0,...,8,9,A,B,...,G] value---No need To do this
    y= np.array([base_17[num] for num in y])
    '''
#     print("y=",y)
#     z=y_test[i]
